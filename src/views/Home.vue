  ...
  <div class="mapWrap">
    ...
    <baidu-map class="bm-view" :center="pos" :zoom="12" :scroll-wheel-zoom="true" @load="onloadMap" @ready="onReady" @tilesloaded="onTilesloaded">
      <template v-for="car in cars">
        <bm-label :labelStyle="{color: 'blue', fontSize : '12px', padding: '5px', borderColor: 'blue', boxShadow: '0 0 10px blue', borderRadius: '100px' }" content='23'
          v-if="car.isMulti"
          :key="car.key"
...
export default {
  ...
  methods: {
    ...
    getBounds() {
      ...
      console.log('bssw, bsne', {bssw, bsne})
      return {bssw, bsne}
    },
    ...
    averageMap() {
      ...
      let _aveMap = [] // 二位数组，每个子数组是块儿的「对角线」位置的经纬度
